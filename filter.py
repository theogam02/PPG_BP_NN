...
def frequency_domain_features(ppg):
    ...
    fourier_first_local_max_frequencies = fourier_local_max_frequencies[0:2] 
    fourier_first_local_max_values = fourier_local_max_values[0:2]
    fourier_first_local_min_frequencies = fourier_local_min_frequencies[0:2]   
    fourier_first_local_min_values = fourier_local_min_values[0:2]
...
file_path = 'D:\\Dokumentumok\\01_PETI\\01_IMPERIAL\\YEAR_3\\TERRA PROJECT\\a_output.csv'
